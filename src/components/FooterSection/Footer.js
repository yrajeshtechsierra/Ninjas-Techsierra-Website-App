      ...
      <View style={styles.QuickLReachinkContainer}>
        <View style={styles.QuickLReachink}>
          <View style={styles.QuickLink}>
            ...
            <TouchableOpacity>
              <Text style={styles.Text}>carrers</Text>
            </TouchableOpacity>
          </View>
          <View style={styles.ReachLink}>
            <Text style={styles.HeaderText}>reach us</Text>
            <TouchableOpacity>
              <Text style={styles.Text}>info@techsierra.in</Text>
            </TouchableOpacity>
            <TouchableOpacity>
              <Text style={styles.Text}>+91 9819783891</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
      ...
      <View style={styles.socialContainer}>
        <View style={styles.wrapperContainer}>
          <View style={styles.ImageContainer}>
            <Image
              source={backgroundImage.FooterLogo}
          ...
          <View style={styles.socialIcon}>
            <TouchableOpacity>
              <Image source={social.linkdin} style={styles.iconImage} />
            </TouchableOpacity>
            <TouchableOpacity>
              <Image source={social.twitter} style={styles.iconImage} />
            </TouchableOpacity>
            <TouchableOpacity>
              <Image source={social.instagram} style={styles.iconImage} />
            </TouchableOpacity>
            <TouchableOpacity>
              <Image source={social.youtube} style={styles.iconImage} />
            </TouchableOpacity>
          </View>
          <View style={styles.footerContent}>
            <Text style={styles.footerTextContent}>
              &copy; copyright U18, LLC.
            </Text>
            <TouchableOpacity>
              <Text style={styles.footerTextContent}>privacy policy</Text>
            </TouchableOpacity>
            <TouchableOpacity>
              <Text style={styles.footerTextContent}>terms of services</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
